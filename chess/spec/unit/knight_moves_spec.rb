  ...
  RSpec.describe 'The board is setup.' do
    ...
    context 'The four knights game is played.' do
      ...
      it 'Black opens with "d5".' do
        expect(game.black_move("d5")).to eq(true)
      end

      it 'White moves knight to Nc3.' do
        expect(game.white_move("Nc3")).to eq(true)
      end

      it 'Black moves knight to Nc6' do 
        expect(game.black_move("Nc6")).to eq(true)
      end
      ...
      it 'Black moves "e5"' do
        expect(game.black_move("e5")).to eq(true)
      end

      it 'White moves "Nf3"' do
        expect(game.white_move("Nf3")).to eq(true)
      end

      it 'Black moves "Nf6"' do
        expect(game.black_move("Nf6")).to eq(true)
      end

      it 'White Knight 1 takes black pawn Nxd5' do 
        expect(game.white_move("Nxd5")).to eq(true)
      end
